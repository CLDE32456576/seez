    ...
    <div className="bg-[#121414]" style={{ minHeight: '100vh', display: 'flex' }}>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 440 }}>
          <h1 className="font-header" style={{ fontSize: 28, fontWeight: 500, color: '#c8c6c5', marginBottom: 6 }}>Welcome back</h1>
          <p className="font-mono-data" style={{ fontSize: 12, color: '#8e9192', marginBottom: 36 }}>Log in to continue your training.</p>
          ...
          <p className="font-mono-data" style={{ textAlign: 'center', fontSize: 12, color: '#8e9192', marginTop: 24 }}>
            No account?{' '}
            <Link to="/signup" style={{ color: '#dcc662', textDecoration: 'none' }}>Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
